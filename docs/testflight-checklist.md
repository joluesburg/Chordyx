...
- [ ] **Privacy URL live** — GitHub Pages `privacy.html` reachable for App Store Connect
...
- [ ] **Onboarding** — first launch explains host vs join vs practice
...
- [ ] **Remove duplicate UI** — Back + Cancel on same sheet (if still present)
...
|------------|---------------------|
| Same local network required | “Not for remote band members in different locations.” |
| No cloud backup | “Save progressions on each device; no automatic sync between your iPad and iPhone.” |
